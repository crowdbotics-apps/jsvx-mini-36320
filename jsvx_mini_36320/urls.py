"""jsvx_mini_36320 URL Configuration
...
admin.site.site_title = "JSVX mini Admin Portal"
admin.site.index_title = "JSVX mini Admin"

# swagger
api_info = openapi.Info(
    title="JSVX mini API",
    default_version="v1",
    description="API documentation for JSVX mini App",
)
